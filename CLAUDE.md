...
### 🏗️ ETAPA 1: Setup Base + Database
**Duração**: 3-4 horas | **Status**: [ ] TODO

**Objetivo**: Infraestrutura RDS MySQL funcionando
...
**Critérios de Sucesso**: RDS rodando + conectividade + schema criado + seeds inseridos

**Sinalização para Claude Code**: "ETAPA 1 concluída"

---

### ⚡ ETAPA 2: Lambda de Autenticação  
**Duração**: 4-5 horas | **Status**: [ ] TODO

**Objetivo**: Lambda de autenticação (CPF + anônimo) funcionando
...
**Critérios de Sucesso**: Lambda deployed + conecta RDS + auth CPF/anônimo + JWT gerado
