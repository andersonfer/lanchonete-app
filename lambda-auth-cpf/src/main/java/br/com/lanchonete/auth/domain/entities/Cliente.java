package br.com.lanchonete.auth.domain.entities;

import br.com.lanchonete.auth.domain.valueobjects.Cpf;
import br.com.lanchonete.auth.domain.valueobjects.Email;
...
public class Cliente {
    ...
    // Construtor para cliente anônimo (permite nulls)
    private Cliente(Long id, String nome, Email email, Cpf cpf, boolean anonimo) {
        this.id = id;
        this.nome = nome;
        this.email = email;
        this.cpf = cpf;
    ...
    public static Cliente criarAnonimo() {
        return new Cliente(null, "Cliente Anônimo", null, null, true);
    }
