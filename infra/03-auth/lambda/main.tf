...
resource "aws_lambda_function" "auth_lambda" {
  filename         = "${path.module}/../lambda-src/target/lanchonete-auth-lambda-1.0.0.jar"
  ...
  source_code_hash = filebase64sha256("${path.module}/../lambda-src/target/lanchonete-auth-lambda-1.0.0.jar")
