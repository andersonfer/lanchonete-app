...
class WebhookControllerTest {
    ...
    void t1() throws Exception {
        // Arrange
        WebhookPagamentoRequestDTO webhookRequest = new WebhookPagamentoRequestDTO(1L, "APROVADO");
    ...
    void t2() throws Exception {
        // Arrange
        WebhookPagamentoRequestDTO webhookRequest = new WebhookPagamentoRequestDTO(1L, "REJEITADO");
        String requestJson = objectMapper.writeValueAsString(webhookRequest);
    ...
    void t3() throws Exception {
        // Arrange
        WebhookPagamentoRequestDTO webhookRequest = new WebhookPagamentoRequestDTO(999L, "APROVADO");
        String requestJson = objectMapper.writeValueAsString(webhookRequest);
    ...
    void t5() throws Exception {
        // Arrange
        WebhookPagamentoRequestDTO webhookRequest = new WebhookPagamentoRequestDTO(1L, "INVALIDO");
        String requestJson = objectMapper.writeValueAsString(webhookRequest);
    ...
    void t6() throws Exception {
        // Arrange
        WebhookPagamentoRequestDTO webhookRequest = new WebhookPagamentoRequestDTO(null, "APROVADO");
        String requestJson = objectMapper.writeValueAsString(webhookRequest);
    ...
    void t7() throws Exception {
        // Arrange
        WebhookPagamentoRequestDTO webhookRequest = new WebhookPagamentoRequestDTO(1L, null);
        String requestJson = objectMapper.writeValueAsString(webhookRequest);
